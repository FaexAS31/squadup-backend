...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('ADMIN', 'Super Admin'), ('MANAGER', 'Manager'), ('SUPPORT', 'Soporte'), ('REGULAR', 'Usuario Regular')], default='REGULAR', max_length=20)),
            ...
            options={
                'db_table': 'users',
                'indexes': [models.Index(fields=['firebase_uid'], name='users_firebas_361636_idx'), models.Index(fields=['email'], name='users_email_4b85f2_idx'), models.Index(fields=['role'], name='users_role_0ace22_idx'), models.Index(fields=['is_active'], name='users_is_acti_847b48_idx'), models.Index(fields=['created_at'], name='users_created_6541e9_idx')],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image_url', models.URLField(help_text='Full-size image URL from Firebase Storage', max_length=500)),
                ('thumbnail_url', models.URLField(blank=True, default='', help_text='Thumbnail URL for faster loading in lists', max_length=500)),
                ('order', models.PositiveSmallIntegerField(default=0, help_text='Display order (0 = first)')),
                ('caption', models.CharField(blank=True, default='', help_text='Optional caption for the photo', max_length=200)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gallery_photos', to='api.user')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='memory',
            name='created_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_memories', to='api.user'),
        ),
        migrations.CreateModel(
            name='MeetupPlan',
            fields=[
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['user', 'order'], name='profile_pho_user_id_9e3ff0_idx'),
        ),
        migrations.AddIndex(
            model_name='paymentmethod',
